...
public class Leer {
    ...
    public int pedirInt() {
        ...
        do {
            correcto = true;
            try {
                System.out.println("Introduce un numero entero integer POR FAVOR");
                num = sc.nextInt();
            } catch (InputMismatchException ex) {
                // En caso de error, se marca como incorrecto
                correcto = false;
            ...
            if (!correcto) {     //En caso de error, muestro el error
...
//                	System.out.println(num + " es de tipo int");
//                }
               
            } catch (InputMismatchException ex) {
                // En caso de error de excepcion, el num se marca como un numero no valido
                num = maximo + 1;  //en el siguiente IF va a sacar el SOUT y ademas hace el WHILE otra vez
                sc.next();
            }
